...
require_once 'lib/spreadsheet/Writer/Format.php';
require_once 'lib/spreadsheet/Writer/BIFFwriter.php';
require_once 'lib/spreadsheet/Writer/Worksheet.php';
require_once 'lib/spreadsheet/Writer/Parser.php';
require_once 'lib/spreadsheet/ole/Root.php';
require_once 'lib/spreadsheet/ole/File.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    ...
    {
        include_once 'lib/spreadsheet/Writer/Validator.php';
