...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'ext/lib/lightbox/loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'ext/lib/lightbox/prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'ext/lib/lightbox/next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'ext/lib/lightbox/close.gif',		// (string) Path and the name of the close btn
			imageBlank:				'ext/lib/lightbox/blank.gif',			// (string) Path and the name of a blank image (one pixel)
		...
		function _set_image_to_view() { // show the loading
			...
			objImagePreloader.onload = function() {
				...
				// tb
				var arrPageSizes = ___getPageSize();
				objImagePreloader.width = Math.min(objImagePreloader.width, arrPageSizes[0]*0.9);
				objImagePreloader.height = Math.min(objImagePreloader.height, (arrPageSizes[1]-50)*0.9);
