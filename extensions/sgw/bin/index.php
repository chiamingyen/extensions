<?php
  ...
  if (!defined("NOCONTENT") and !login_browser_detect() and !DEBUG and empty($_REQUEST["export"])) sys_die("Browser not supported: ".sys::$browser["str"],login::browser_detect_toString());
  if (!DEBUG and SETUP_LANGUAGE!="en") sys_die(sprintf("Program is installed with language %s, please use a different url or run the setup again.",SETUP_LANGUAGE));
