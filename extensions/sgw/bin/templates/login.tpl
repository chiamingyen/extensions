...
<div id="login_table_obj" style="text-align:center; {if $smarty.const.SELF_REGISTRATION}{if $sys.browser.is_mobile}top:10%;{else}top:33%;{/if}{/if}">
  <table style="margin:auto;"><tr><td class="login_table" style="{if !$sys.browser.is_mobile}padding:0 75px;{/if}">
	...
	{if $page eq ""}<input class="checkbox" id="redirect" type="checkbox" name="redirect" value="1" style="margin:0px; margin-bottom:2px;" {if !$login[0] && !$login[2]}checked{/if}> <label for="redirect" class="default10">Redirect to home directory</label>{/if}
	</div>
	</form>
  </td></tr>
  </table>
  ...
  <table style="margin:auto;"><tr><td class="login_table" style="{if !$sys.browser.is_mobile}padding:0 75px;{/if}">
	...
	<tr>
	  <td style="text-align:center;" colspan="2">Self registration<hr></td>
	</tr>
	<tr>
	  <td class="default10">Username</td>
	  <td><input type="text" name="username" value=""/></td>
	</tr>
	<tr>
	  <td class="default10" rowspan="2">Password</td>
	...
	<tr>
	  <td class="default10">E-mail</td>
	  <td><input type="text" name="email" value=""/></td>
	</tr>
	<tr>
	  <td></td>
	  <td><input type="submit" value=" R e g i s t e r "></td>
	</tr>
	</table>
	</form>
  </td></tr>
