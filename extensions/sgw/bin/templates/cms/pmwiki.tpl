...
<body class="body">
  ...
  <table id="wikimid" width="100%" cellspacing="0" cellpadding="0"><tr>
    <td id="wikileft" valign="top">
	  ...
	  <p class="vspace" style="text-align: right;">
		<span style="font-size:83%;">- <a target="_blank" href="?page=Site.SideBar&edit">Edit</a> -</span>
	  </p>
	</td>
  ...
  <div id="wikifoot">
    <div class="footnav">
	  {if $smarty.session.username neq "anonymous"}<a href="?logout" accesskey="l">Logout</a> - {/if}
	  <a href="?rss">Recent changes</a> - 
	  <a target="_blank" href="?page={$page.pagename|escape:"html"}&edit" accesskey="e">Edit</a> - 
	  <a href="?page={$page.pagename|escape:"html"}&source">Source</a> - 
	  <a href="?page=Site.Search">Search</a>
	</div>
    <div class="lastmod">Page last modified on {$page.lastmodified|modify::localdateformat:"F j, Y"}</div>
  </div>
</body>
</html>
