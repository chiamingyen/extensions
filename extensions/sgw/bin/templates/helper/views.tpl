...
<div id="views">
  ...
  <div style="float:{if #direction#}right{else}left{/if};" id="loading">
    <span id="tree_button" style="display:none;" onclick="tree_showhide();" class="tabstyle">Tree</span>
    ...
    {if ($t.sqlvars.item && $t.maxdatasets>$t.datasets) || $t.sqlfilters}
	  <a href="index.php?session_remove_request&filters=" class="tabstyle" title="Alt-&lt;" accesskey="<">[All]</a>
    {/if}
	...
	{if $t.views.new && !$t.att.DISABLE_QUICK_ADD && $t.att.ENABLE_NEW && $t.schema_mode eq ""}
	  ...
	  {if $fields}
        <a title="Quick add [Alt-k]" href="#" onclick="asset_insert_prompt('{$fields|@array_keys|@implode:"|"}','{$fields|@implode:"|"}'); return false;" accesskey="k">
