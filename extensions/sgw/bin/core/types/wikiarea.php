...
EOT;
  $output = $init.<<<EOT
	<div style="margin-bottom:1px;">
	  <input type="button" value="Preview" onclick="wikiarea_preview('{$name}'); getObj('{$name}').focus();">&nbsp;
	  <input type="button" value="Text formatting rules" onclick="nWin('../docs/ext/wiki/wiki.htm');">
	</div>
...
static function ajax_wikiarea_render_preview($data) {
  return sys_remove_trans("<b>Preview:</b>")."<br/><br/>".modify::htmlfield(self::render_page($data));
}
