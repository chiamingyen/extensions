...
EOT;
  ...
  $output = $init.<<<EOT
	...
	<input type="button" value="Preview" onclick="graphviz_open_preview('{$name}'); getObj('{$name}').focus();">&nbsp;
	<input type="button" value="Examples" onclick="nWin('http://graphviz.org/Gallery.php');">&nbsp;
	<input type="button" value="Shapes" onclick="nWin('http://graphviz.org/doc/info/shapes.html');">&nbsp;
	<input type="button" value="Documentation" onclick="nWin('http://graphviz.org/pdf/dotguide.pdf');">
	</div>
